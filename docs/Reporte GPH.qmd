...
Así mismo, fue necesario realizar una serie de modificaciones al dataset original totalizando las estadísticas por cada juego (Esto se realizo por cada uno de los equipos, en este caso, visitante y local) de tal forma que se obtiene la información semanal, este dataset es el que será utilizado para realizar la predicción.
